...
1. populate null value in the property address
2. split property address and owner address into detial, city and province
3. standardized the sold or vacant field
4. use CTE to check if there is dulicate and remove them
